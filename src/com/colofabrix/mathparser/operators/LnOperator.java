...
public class LnOperator extends Operator {

    public LnOperator() throws ConfigException {
        super();
        this.setBaseName( "Ln" );
    ...
    public Operand executeOperation( Stack<ExpressionEntry> operands ) throws ExpressionException {
        ...
        return new Operand( ApfloatMath.log( value1, ApfloatMath.exp( new Apfloat( 1 ) ) ) );
    }
}
